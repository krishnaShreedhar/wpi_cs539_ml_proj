...
echo "Starting to run SBATCH SCRIPT FOLD 2"

source /home/sskodate/py37_venv/bin/activate

python3 mri_nw_param.py --model_to_train=3dcnn --epochs=50 --initial_lr=0.01 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T1w --max_data=1000 --batch_size=2
python3 mri_nw_param.py --model_to_train=resnet --epochs=50 --initial_lr=0.001 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T1w --max_data=1000 --batch_size=2
python3 mri_nw_param.py --model_to_train=3dcnn --epochs=50 --initial_lr=0.01 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T1wCE --max_data=1000 --batch_size=2
python3 mri_nw_param.py --model_to_train=resnet --epochs=50 --initial_lr=0.001 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T1wCE --max_data=1000 --batch_size=2
python3 mri_nw_param.py --model_to_train=3dcnn --epochs=50 --initial_lr=0.01 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T2w --max_data=1000 --batch_size=2
python3 mri_nw_param.py --model_to_train=resnet --epochs=50 --initial_lr=0.001 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=2 --mri_type=T2w --max_data=1000 --batch_size=2
...
python3 mri_nw_param.py --model_to_train=resnet --epochs=50 --initial_lr=0.001 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=4 --mri_type=T1w --max_data=1000 --batch_size=2
...
python3 mri_nw_param.py --model_to_train=resnet --epochs=50 --initial_lr=0.001 --decay_steps=100000 --decay_rate=0.96 --patience=50 --verbose=2 --w_width=128 --d_depth=32 --classes=2 --fold_num=4 --mri_type=T1wCE --max_data=1000 --batch_size=2
