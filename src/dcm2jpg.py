...
# something like the below can be used to loop through all patients and convert all at once
# mri_type = 'FLAIR'
...
original_dicom_directory = '../data/00192/T1w/'  # renamed folder structure for patient 00000 (just for demo here)
output_file = '../outputs/Nifti/T1w/'
jpg_output_folder = '../outputs/JPG/Tw1/'
