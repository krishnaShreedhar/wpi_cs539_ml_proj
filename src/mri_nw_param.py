...
# !unzip "/nifti_zips" + mri_type + ".zip"
# from zipfile import ZipFile
# mri_type = "FLAIR"
# with ZipFile("nifti_zips/" + mri_type + ".zip", 'r') as zipObj:
...
def parse_args():
    ...
    parser.add_argument("--decay_steps",
                        type=int,
                        help="learning rate decay_steps",
                        default=100000)
    parser.add_argument("--decay_rate",
                        type=float,
                        help="learning rate decay_rate",
                        default=0.96)
...
def train_cnn(mri_type, fold_num, train_dataset, validation_dataset,
              epochs=50,  # 2  # 100
              initial_lr=0.01,  # 0.0001 # initial learning rate
              decay_steps=100000,  # # decay steps in the exponential learning rate scheduler
              decay_rate=0.96,
...
def train(dict_args):
    ...
    patient_scans_val = np.array(patient_scans_val)
